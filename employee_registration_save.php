...
<body>
 ...
 <input type="file" style="margin top:10px; text:center;"
 id="uploadfile" name="uploadfile" value=""/>
 </div>
 </form>
 <form id="employee_registration_save" class="a-form" action="employee_registration_save.php"
method="post" width='840'>
 ...
 <input type="text" class="form-control mt 0" name="fname"
 id="fname" value="">
 </div>
...
<div class="form-group col">
 ...
 <input type="text" class="form-control mt-0" name="lname"
 id="lname" value="">
 </div>
...
<div class="form-group col-3">
 ...
 <input type="text" class="form-control mt-0" name="department"
 id="department" value="">
 </div>
 <div class="form-group col-3">
 ...
 <button type="reset" class="btn btn-outline-secondary" name="cancelbtn" style="width:130px;">Cancel</button>
 </form>
 </div>
 </div>
</body>
